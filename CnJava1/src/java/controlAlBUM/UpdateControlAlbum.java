 ...
 * @author Admin
 */
@WebServlet(name = "UpdateControlAlbum", urlPatterns = {"/updatealbum"})
public class UpdateControlAlbum extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateControlAlbum</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateControlAlbum at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       String maAlbum=request.getParameter("maAlbum");
        ALBUMDAO dao=new ALBUMDAO();
        ALBUM al=dao.getALBUMID(maAlbum);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String sghiChu=request.getParameter("ghiChu");
       ...
       ALBUMDAO dao=new ALBUMDAO();
       dao.updateAlbum(smaAlbum, stenAlbum,smaLoaiAlbum, sthoiLuong,sdaoDien, snhaSanXuat,snamSanXuat, schuDe,sngayPhatHanh, sdonGia,sghiChu);
