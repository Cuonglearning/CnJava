...
public class UpdateControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       String maAlbum=request.getParameter("maAlbum");
        ...
        NGHESY_ALBUM nsal=dao.getNGHESY_ALBUMID(maAlbum);
        request.setAttribute("nsa", nsal);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String smaNgheSy=request.getParameter("maNgheSy");
       NGHESY_ALBUMDAO dao=new NGHESY_ALBUMDAO();
       dao.updateNgheSy_Album(smaAlbum, smaNgheSy);
